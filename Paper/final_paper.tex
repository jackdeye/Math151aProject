...
\begin{center}
	...
	\begin{tabular}{| l | l | r | r | r | r |}
		\hline
		Function & Method & Ending Accuracy & Terminated & Order of Convergence\\
		\hline
		$f(x) = \frac{1}{1 + 1000(x - 0.5)^2}$ & Trapezoid Rule & a & a & a\\
		\hline
		$f(x) = \frac{1}{1 + 1000(x - 0.5)^2}$ & Simpson's Rule & a & a & a\\
		\hline
		$f(x) = \frac{1}{1 + 1000(x - 0.5)^2}$ & Gaussian Quadrature & a & a & a\\
		\hline
		$f(x) = \frac{1}{x}\sqrt{\frac{1 + x}{1 - x}}\log(\frac{2x^2 + 2x + 1}{2x^2 - 2x + 1})$ & Trapezoid Rule & a & a & a\\
		\hline
		$f(x) = \frac{1}{x}\sqrt{\frac{1 + x}{1 - x}}\log(\frac{2x^2 + 2x + 1}{2x^2 - 2x + 1})$ & Simpson's Rule & a & a & a\\
		\hline
		$f(x) = \frac{1}{x}\sqrt{\frac{1 + x}{1 - x}}\log(\frac{2x^2 + 2x + 1}{2x^2 - 2x + 1})$ & Gaussian Quadrature & a & a & a\\
		\hline
		$f(x) = \sqrt{|x|}$ & Trapezoid Rule & a & a & a\\
		\hline
		$f(x) = \sqrt{|x|}$ & Simpson's Rule & a & a & a\\
		\hline
		$f(x) = \sqrt{|x|}$ & Gaussian Quadrature & a & a & a\\
		\hline
		$f(x) = \frac{1}{1 + x^2}$ & Trapezoid Rule & a & a & a\\
		\hline
		$f(x) = \frac{1}{1 + x^2}$ & Simpson's Rule & a & a & a\\
		\hline
		$f(x) = \frac{1}{1 + x^2}$ & Gaussian Quadrature & a & a & a\\
		\hline
		$f(x) = \cos x$ & Trapezoid Rule & a & a & a\\
		\hline
		$f(x) = \cos x$ & Simpson's Rule & a & a & a\\
		\hline
		$f(x) = \cos x$ & Gaussian Quadrature & a & a & a\\
		\hline
	\end{tabular}
	\end{footnotesize}
\end{center}
